...
const StudentSubmission = () => {
  ...
  const getSubmission = () => {
    ...
    axios
      .post(
        "https://cms-backend-phi.vercel.app/classes/getSubmission",
        {
  ...
  const getAssignment = () => {
    ...
    axios
      .post(
        "https://cms-backend-phi.vercel.app/classes/getAssignment",
        {
          assignmentId: assignmentId,
        },
        {
  ...
  const getClassDetails = () => {
    ...
    axios
      .post(
        "https://cms-backend-phi.vercel.app/classes/getClassroom",
        {
          classCode: classCode,
        },
        {
    ...
    uploadTask.on("state_changed", console.log, console.error, () => {
      getDownloadURL(uploadTask.snapshot.ref)
        .then((firebaseURL) => {
          // .then(firebaseURL => {
          return axios.post(
            "https://cms-backend-phi.vercel.app/classes/submitAssignment",
            {
              assignmentId: assignmentId,
  ...
  const unSubmitFile = () => {
    ...
    axios
      .delete(
        "https://cms-backend-phi.vercel.app/classes/deleteSubmission",
        {
          data: {
            assignmentId: assignmentId,
            userEmail: userData.userEmail,

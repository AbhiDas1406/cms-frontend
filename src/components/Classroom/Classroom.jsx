...
const Classroom = () => {
  ...
  useEffect(() => {
    const getReminders = async () => {
      if (storeData.token) {
        ...
        axios
          .post(
            "https://cms-backend-phi.vercel.app/classes/getReminders",
            {
          ...
          .then(async (res) => {
            ...
            for (let reminder of res.data) {
              await axios
                .post("https://cms-backend-phi.vercel.app/classes/getClassroom", {
  ...
  const deleteClass = () => {
    axios
      .delete(
        "https://cms-backend-phi.vercel.app/classes/deleteClassroom",
        {

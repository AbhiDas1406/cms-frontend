...
const Discussion = ({classCode, adminEmail}) => {
    ...
    const getDiscussion = async () => {
        setLoading(true);
        await axios.post("https://cms-backend-phi.vercel.app/classes/getDiscussions",{
            classCode: classCode
        ...
        if (fileInput) {
            ...
            uploadTask.on('state_changed', console.log, console.error, () => {
                getDownloadURL(uploadTask.snapshot.ref).then((firebaseURL) => {
                    return axios.post('https://cms-backend-phi.vercel.app/classes/createDiscussion', {
            ...
            axios.post('https://cms-backend-phi.vercel.app/classes/createDiscussion', {
                creatorEmail: userData.userEmail,
                creatorName: userData.userName,
                classCode: classCode,
                desc: discussionInput
